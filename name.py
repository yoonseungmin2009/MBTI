...
if st.session_state.chosen_mbti:
    ...
    # 포켓몬 스프라이트 URL (PokeAPI 공식 스프라이트)
    sprite_url = f"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/{data['number']}.png"
        ...
        st.markdown(
            ...
            ">
                <img src="{sprite_url}"
                     ...
                     onerror="this.src='https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/{data['number']}.png'"
                />
                <div style="font-size:0.8rem; color:#9ca3af; margin-top:0.3rem;">No.{data['number']}</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    partner_sprite = f"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/{partner['number']}.png"
    st.markdown(
        f"""
        <div style="
        ...
        ">
            <img src="{partner_sprite}" style="width:60px;" />
            <div>
